...
def test_withdraw_full_cycle(
    ...
    start_721 = erc_721_child.withdraw_start(token, from_pk)
    ...
    assert start_20.receipt
    assert start_721.receipt
    assert start_1155.receipt
    ...
    assert end_20.receipt
    assert end_721.receipt
    assert end_1155.receipt
